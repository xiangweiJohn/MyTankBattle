...
public class Blood extends Element implements Destroyable,Treasure,Collapsible {
	...
	public Blood(String imagePath, int x , int y) {
		super(imagePath,x,y);
		switch (imagePath) {
		case Constant.IMAGE_BLOOD_1:
			addBlood = 1;
			break;
		case Constant.IMAGE_BLOOD_2:
			addBlood = 2;
			break;
		case Constant.IMAGE_BLOOD_3:
			addBlood = 3;
			break;
		default:
			break;
